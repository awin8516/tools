...
const mutations = {
  ...
  SET_UPDATEMEDIANAME: (state, component) => {
    ...
    state.screenOptions.style.width = state.screenOptions.sizeList[component].width;
    state.screenOptions.style.height = state.screenOptions.sizeList[component].height;
  },
