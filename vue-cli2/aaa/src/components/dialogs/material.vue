...
export default {
  extends: BaseView,
  props: ["have_btn", "editData", "showCounpon"],
  data() {
    return {
      modal: false,
      interval: "",
  ...
  methods: {
    ...
    editChangeData(data) {
      ...
      switch (parseInt(dataType)) {
        ...
        case 2:
          this.getmelink(() => {
            this.matching(this.meimglink, "id", value);
          });
          break;
        case 3:
          this.getmevoice(() => {
            this.matching(this.mevoice, "media_id", value);
          });
          break;
        case 4:
          this.getmeimgtext(() => {
            this.matching(this.meimgtextData, "id", value);
          });
          break;
        case 5:
          this.getmevideo(() => {
            this.matching(this.mevideo, "media_id", value);
          });
          break;
        case 6:
          this.getmeimg(() => {
            this.matching(this.meimgData, "media_id", value);
          });
          break;
        case 10:
          this.getCoupon(data);
